const fr = {
  ...
  emissions: {
    ...
    noEpisodeDescription: "Aucune description n'est disponible pour cet episode.",
    episodeFallbackTitle: 'Episode',
    episodePublishedOn: 'Publie le {{date}}',
    listenOnProvider: 'Ecouter sur {{provider}}',
    listenAsset: 'Ecouter maintenant',
    episodeAssets: 'Medias disponibles',
    assetLanguage: 'Langue : {{language}}',
    assetDuration: 'Duree : {{duration}}',
  ...
  auth: {
    ...
    googleUnavailable: 'Google Sign-In n’est pas correctement configuré sur cet appareil.',
    googleExchangeFailed: 'La connexion Google a réussi, mais la validation avec le serveur a échoué.',
